...
const InstructionPage:React.FC<InstructionProps>=({onQuiz})=> {
    ...
    <div className="max-w-md space-y-4 text-center">
      ...
      <div className="space-y-4 text-left">
        ...
        <ul className="list-disc space-y-2 pl-6 text-gray-500 dark:text-gray-400">
          ...
          <li>
            Answer all questions within the given time limit to maximize your
            score.
          </li>
          <li>
            The quiz may contain questions from various categories. Be
            prepared for a diverse range of topics.
          </li>
        </ul>
      </div>
      <div className="mb-6">
