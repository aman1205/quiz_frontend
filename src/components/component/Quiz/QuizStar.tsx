      ...
      <div className="mt-16 max-w-3xl space-y-8">
        ...
        <section className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            ...
            and have fun while doing it. It&apos;s a great way to test yourself
        ...
        <section className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Click the &quot;Start Quiz&quot; button above to begin your journey.
            Challenge yourself, enjoy the quiz, and see how much you know!
          </p>
        </section>
      </div>
      <div className="mt-8">
